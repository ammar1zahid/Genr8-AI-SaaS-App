...
const Navbar = () => {
    ...
    return (
        <div className="fixed z-5 w-full backdrop-blur-2xl flex justify-between items-center h-[10vh] px-4 sm:px-20 xl:px-32 cursor-pointer">
            {/* Logo, navigates to home on click */}
            <img
                src={assets.logo}
                alt="logo"
                className='w-36 sm:w-48 cursor-pointer mt-4'
                onClick={() => navigate("/")}
            />
